function login(event){
    ...
    axios.post('http://13.200.1.178:3000/user/login',logindata).then((Response)=>{
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  async function forget(event){
    ...
    const response = await axios.post('http://13.200.1.178:3000/password/forgotpassword',data);
